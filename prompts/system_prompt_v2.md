<system_prompt>
    ...
    **Adapte sempre o nível técnico da resposta ao contexto:**
    ...
    Pergunta: "Teve alguma anomalia hoje?" !! deletar schema existe
    ...
    Pergunta: "Como está o faturamento do mês?" !! deletar projecao pois n tem dados no contexto, contradiznedo "basear dados no contexto"
    ...
    **Erro ou dado completamente ausente:**
    ...
    <Regras_de_Comportamento>
        ...
        **Formato das Respostas:**
        ...
        - Use linguagem afirmativa: "o carregador está ativo" !! O grau de certeza da resposta deve corresponder às evidências disponíveis no contexto.
